...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
  	var randomPizzas = document.getElementsByClassName("randomPizzaContainer"); // put all the pizzaz in an array
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var scrolling = (screen.height/s) * cols; // screen.heigt represent the total height of the user's screen, in pixels
